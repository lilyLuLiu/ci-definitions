...
for file_name in txt_files:
    ...
    if "time-consume.txt" == file_name:
        ...
        cpufile = file_path
    elif "time-stamp.txt" == file_name:
        tiemstampfile = file_path
...
if cpufile != "" and tiemstampfile != "":
    startCPU, stopCPU = analyzedata.analyze_cpu_data(cpufile, tiemstampfile)
    all["cpu-Start"] = startCPU
    all["cpu-Stop"] = stopCPU
    count=count+1
